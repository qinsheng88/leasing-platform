<template>
	<view class="evan-form-show">
		<evan-form :hide-required-asterisk="hideRequiredAsterisk" ref="form" :model="info">
			...
			<!-- 测试用 开始 -->
			<evan-form-item label="真实姓名：" prop="realName">
				<input class="form-input" placeholder-class="form-input-placeholder" v-model="info.realName" placeholder="请输入真实姓名" />
			</evan-form-item>
			<evan-form-item label="证件类型：" prop="certNo">
				<input class="form-input" placeholder-class="form-input-placeholder" v-model="info.certNo" placeholder="请输入证件类型" />
			</evan-form-item>
			<!-- 测试用 结束-->
